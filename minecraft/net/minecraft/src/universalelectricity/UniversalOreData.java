...
public class UniversalOreData
{
	 ...
	 */
	public UniversalOreData(String name, String oreDiectionaryName, int textureIndex, int minGenerateLevel, int maxGenerateLevel, int amountPerChunk, int amountPerBranch, boolean addToCreativeList, String harvestTool, int harvestLevel)
	{
		this.name = name;
	...
	public UniversalOreData(String name, String oreDiectionaryName,  int textureIndex, int maxGenerateLevel, int amountPerChunk, int amountPerBranch)
	{
	...
	public int getBlockTextureFromSide(int side) { return this.blockIndexTexture; }
