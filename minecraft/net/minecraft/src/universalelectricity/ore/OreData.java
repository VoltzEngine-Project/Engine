...
public class OreData
{
    ...
    private static boolean shouldGenerateOre(String oreName)
    {
        ...
        boolean shouldGenerate = Boolean.parseBoolean(UniversalElectricity.CONFIGURATION.getOrCreateBooleanProperty("Generate_" + oreName.replaceAll(" ", "_"), Configuration.CATEGORY_GENERAL, true).value);
