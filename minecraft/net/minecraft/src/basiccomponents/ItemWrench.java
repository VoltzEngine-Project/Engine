...
public class ItemWrench extends BCItem
{
    ...
    {    	
    	if(Block.blocksList[par3World.getBlockId(x, y, z)] instanceof IWrenchable)
    	{
            ...
            {
    			return ((IWrenchable)Block.blocksList[par3World.getBlockId(x, y, z)]).onSneakUseWrench(par3World, x, y, z, par2EntityPlayer);
            }
    		else
    		{
    			return ((IWrenchable)Block.blocksList[par3World.getBlockId(x, y, z)]).onUseWrench(par3World, x, y, z, par2EntityPlayer);
    		}
    	}
