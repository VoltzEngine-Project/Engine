...
public class ModelCopperWire extends ModelBase
{
	...
	public ModelCopperWire()
	{
		textureWidth = 64;
		textureHeight = 32;
		int wireWidth = (int) (((BlockConductor) BasicComponents.blockCopperWire).wireWidth * 16);
		Middle = new ModelRenderer(this, 0, 0);
		Middle.addBox(-1F, 8F, -1F, wireWidth * 2, wireWidth, wireWidth * 2);
		Middle.setRotationPoint(-1F, 14F, -1F);
		Middle.setTextureSize(64, 32);
		Middle.mirror = true;
		setRotation(Middle, 0F, 0F, 0F);
		Right = new ModelRenderer(this, 21, 0);
		Right.addBox(0F, 8F, 0F, 8 - wireWidth, wireWidth, wireWidth * 2);
		Right.setRotationPoint(2F, 14F, -2F);
		Right.setTextureSize(64, 32);
		Right.mirror = true;
		setRotation(Right, 0F, 0F, 0F);
		Left = new ModelRenderer(this, 21, 0);
		Left.addBox(0F, 8F, 0F, 8 - wireWidth, wireWidth, wireWidth * 2);
		Left.setRotationPoint(-8F, 14F, -2F);
		Left.setTextureSize(64, 32);
		Left.mirror = true;
		setRotation(Left, 0F, 0F, 0F);
		Back = new ModelRenderer(this, 0, 11);
		Back.addBox(0F, 8F, 0F, wireWidth * 2, wireWidth, 8 - wireWidth);
		Back.setRotationPoint(-2F, 14F, 2F);
		Back.setTextureSize(64, 32);
		Back.mirror = true;
		setRotation(Back, 0F, 0F, 0F);
		Front = new ModelRenderer(this, 0, 11);
		Front.addBox(0F, 8F, 0F, wireWidth * 2, wireWidth, 8 - wireWidth);
		Front.setRotationPoint(-2F, 14F, -8F);
		Front.setTextureSize(64, 32);
		Front.mirror = true;
		setRotation(Front, 0F, 0F, 0F);
		Top = new ModelRenderer(this, 21, 11);
		Top.addBox(0F, 8F, 0F, wireWidth * 2, 8, wireWidth * 2);
		Top.setRotationPoint(-2F, 8F, -2F);
		Top.setTextureSize(64, 32);
		Top.mirror = true;
		setRotation(Top, 0F, 0F, 0F);
		Bottom = new ModelRenderer(this, 21, 11);
		Bottom.addBox(0F, 6F, 0F, wireWidth * 2, 8, wireWidth * 2);
