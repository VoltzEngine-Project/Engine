...
public class Vector3 implements Cloneable
{
	...
	{
		return world.setBlockAndMetadata(this.intX(), this.intY(), this.intZ(), id, metadata);
	}
	...
	public boolean setBlockWithNotify(World world, int id, int metadata)
	{
		return world.setBlockAndMetadataWithNotify(this.intX(), this.intY(), this.intZ(), id, metadata);
	}

	public boolean setBlockWithNotify(World world, int id)
	{
		return world.setBlockWithNotify(this.intX(), this.intY(), this.intZ(), id);
	}
