...
public final class Items
{
	 ...
	 * rubberWood
	 * rubberLeaves Rubber Leaves block, currently not meta sensitive, meta in ItemStack set to 0,
	 * null with enableWorldGenTreeRubber=false
	 * rubberSapling Rubber Sapling block, currently not meta sensitive, meta in ItemStack set to 0,
	 * null with enableWorldGenTreeRubber=false
	 ...
	 * reinforcedDoorBlock Reinforced Door block, meta reflects the state (see vanilla doors), meta
	 * in ItemStack set to 0
	 ...
	 * dynamiteStickWithRemote Dynamite Stick with Remote block, meta = placement, meta in ItemStack
	 * set to 0
	 * Agriculture Stuff
	 ...
	 * diamondDrill Diamond Tipped Mining Drill item, meta = visual charge indicator, implements
	 * IElectricItem
	 ...
	 * electricTreetap Electric Treetap item, meta = visual charge indicator, implements
	 * IElectricItem
	 ...
	 * odScanner Ore Density Scanner item, meta = damage value for charge level, implements
	 * IElectricItem
	 ...
	 * IElectricItem
	 * quantumBodyarmor Quantum Bodyarmor item, meta = visual charge indicator, implements
	 * IElectricItem
	 * quantumLeggings Quantum Leggings Armor item, meta = visual charge indicator, implements
	 * IElectricItem
	 * quantumBoots Quantum Boots Armor item, meta = visual charge indicator, implements
	 * IElectricItem
	 * jetpack Jetpack item, meta = damage value for fuel level
	 * electricJetpack Electric Jetpack item, meta = visual charge indicator, implements
	 * IElectricItem
	 * batPack BatPack item, meta = visual charge indicator, implements IElectricItem, can provide
	 * energy
	 * lapPack LapPack item, meta = visual charge indicator, implements IElectricItem, can provide
	 * energy
	 ...
	 * chargedReBattery RE Battery item, meta = visual charge indicator, implements IElectricItem,
	 * can provide energy
	 * energyCrystal Energy Crystal item, meta = visual charge indicator, implements IElectricItem,
	 * can provide energy
	 * lapotronCrystal Lapotron Crystal item, meta = visual charge indicator, implements
	 * IElectricItem, can provide energy
	 ...
	 * cultivationTerraformerBlueprint Cultivation Terraformer Blueprint item, currently not meta
	 * sensitive
	 ...
	 * sensitive
	 * desertificationTerraformerBlueprint Desertification Terraformer Blueprint item, currently not
	 * meta sensitive
