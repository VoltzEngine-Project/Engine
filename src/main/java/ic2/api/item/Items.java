 ...
 * The items are initialized while IC2 is being loaded - try to use ModsLoaded() or load your mod
 * after IC2.
 * Some blocks/items can be disabled by a config setting, so it's recommended to check if they're
 * null first.
 * 
...
public final class Items
{
	 ...
	 * Possible values:
	 * // ores
	 * copperOre; // Copper Ore block, currently not meta sensitive, meta in ItemStack set to 0, ore
	 * dictionary: oreCopper, null with enableWorldGenOreCopper=false
	 * tinOre; // Tin Ore block, currently not meta sensitive, meta in ItemStack set to 0, ore
	 * dictionary: oreTin, null with enableWorldGenOreTin=false
	 * uraniumOre; // Tin Ore block, currently not meta sensitive, meta in ItemStack set to 0, ore
	 * dictionary: oreUranium, null with enableWorldGenOreUranium=false
	 * leadOre; // Lead Ore Block, currently not meta sensitive, meta in ItemStack set to 0, ore
	 * dictionary: oreLead, null with enableWorldGenOreLead=false
	 * // rubber related
	 * Rubber wood block, meta reflects the state, meta in ItemStack set to 0, ore dictionary:
	 * woodRubber (with meta 0), null with enableWorldGenTreeRubber=false
	 ...
	 * rubberWood;
	 * rubberLeaves; // Rubber Leaves block, currently not meta sensitive, meta in ItemStack set to
	 * 0, null with enableWorldGenTreeRubber=false
	 * rubberSapling; // Rubber Sapling block, currently not meta sensitive, meta in ItemStack set
	 * to 0, null with enableWorldGenTreeRubber=false
	 * resinSheet; // Resin Sheet block, currently not meta sensitive
	 * rubberTrampoline; // Rubber Trampoline block, meta reflects internal state, meta in ItemStack
	 * set to 0
	 * // building/storage
	 ...
	 * reinforcedDoorBlock; // Reinforced Door block, meta reflects the state (see vanilla doors),
	 * meta in ItemStack set to 0
	 * constructionreinforcedFoam; // Construction Reinforced Foam block, currently not meta
	 * sensitive
	 * constructionFoam; // Construction Foam block, currently not meta sensitive
	 * constructionFoamWall; // Construction Foam Wall block, meta = color, implements
	 * IPaintableBlock
	 ...
	 * // cables (when placed as a block, inventory items are different; TE implements
	 * IEnergyConductor)
	 ...
	 * miningPipeTip; // Mining Pipe Tip block, currently not meta sensitive, meta in ItemStack set
	 * to 0
	 * // personal blocks
	 ...
	 * dynamiteStickWithRemote; // Dynamite Stick with Remote block, meta = placement, meta in
	 * ItemStack set to 0
	 * // Agriculture Stuff
	 ...
	 * // ingots
	 * @Deprecated
	 * refinedIronIngot; // Refined Iron Ingot item, currently not meta sensitive, ore dictionary:
	 * ingotRefinedIron
	 ...
	 * reactorCoolantTriple ; // Coolant Cell item, NBT for heat-storage, meta is 0-10000 for
	 * display
	 * reactorCoolantSix;
	 * reactorPlating; // Integrated Reactor Plating item, currently not meta sensitive
	 * reactorPlatingHeat;
	 * reactorPlatingExplosive;
	 * reactorHeatSwitch; // Integrated Heat Disperser item, NBT for heat-storage, meta is 0-10000
	 * for display
	 ...
	 * reactorVentDiamond;
	 * reactorReflector; // Increase efficiency without additional ticks, NBT for heat-storage, meta
	 * is 0-10000 for display
	 * reactorReflectorThick; // Increase efficiency without additional ticks, NBT for heat-storage,
	 * meta is 0-10000 for display
	 * reactorCondensator; // Consumes redstone to absorb heat, NBT for storage, meta is 0-10000 for
	 * display
	 * reactorCondensatorLap; // Consumes redstone/lapis to absorb heat, mNBT for storage, meta is
	 * 0-10000 for display
	 * // terraformer blueprints
	 * terraformerBlueprint; // Empty Terraformer Blueprint item, currently not meta sensitive
	 * cultivationTerraformerBlueprint; // Cultivation Terraformer Blueprint item, currently not
	 * meta sensitive
	 * irrigationTerraformerBlueprint; // Irrigation Terraformer Blueprint item, currently not meta
	 * sensitive
	 * chillingTerraformerBlueprint; // Chilling Terraformer Blueprint item, currently not meta
	 * sensitive
	 * desertificationTerraformerBlueprint; // Desertification Terraformer Blueprint item, currently
	 * not meta sensitive
	 * flatificatorTerraformerBlueprint; // Flatificator Terraformer Blueprint item, currently not
	 * meta sensitive
	 * mushroomTerraformerBlueprint; // Mushroom Terraformer Blueprint item, currently not meta
	 * sensitive
	 * // diamond chain
