...
public class GuiMessageBox extends GuiBase
{
	...
	public void initGui()
	{
		...
		this.buttonList.add(new GuiButton(0, (this.width - xSize) / 2 + 25, (this.height - ySize) / 2 + 35, 50, 20, "Yes"));
		this.buttonList.add(new GuiButton(1, (this.width - xSize) / 2 + 80, (this.height - ySize) / 2 + 35, 50, 20, "No"));
	...
	{
		this.fontRenderer.drawString("" + this.title, (xSize / 2 - 30), 5, 4210752);
		this.fontRenderer.drawString("\u00a77" + this.message, ((xSize / 2) - 50), 20, 4210752);
	}
