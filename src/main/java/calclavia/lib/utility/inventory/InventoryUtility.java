...
public class InventoryUtility
{
     ...
     * 
     * @param world - world
     * @param x - xCoord, doubles are casted to int
     * @param y - yCoord, doubles are casted to int
     * @param z - zCoord, doubles are casted to int
    ...
    public static boolean placeItemBlock(World world, double x, double y, double z, ItemStack itemStack)
    {
        //TODO implement support for micro blocks
        Block block = Block.blocksList[world.getBlockId((int) x, (int) y, (int) z)];
        if (block == null || block.isAirBlock(world, (int) x, (int) y, (int) z))
        {
