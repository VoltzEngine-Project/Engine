	...
	public static void renderBlockWithConnectedTextures(byte renderSides, Block faceBlock, Icon faceOverride, Block edgeBlock, Icon edgeOverride)
	{
		...
		for (int i = 0; i < 6; i++)
		{
			...
			if (!canRenderSide(renderSides, dir))
			{
				...
				renderCube(-0.501, -0.501, -0.501, 0.501, -0.475, 0.501, faceBlock, faceOverride);
				GL11.glPopMatrix();
			}
		}
		...
		if (!east)
		{
			...
			{
				// north east
				renderCube(0.475, -0.501, -0.501, 0.501, 0.501, -0.475, edgeBlock, edgeOverride);
			}
			if (!south)
			{
				// south east
				renderCube(0.475, -0.501, 0.475, 0.501, 0.501, 0.501, edgeBlock, edgeOverride);
			}

			if (!down)
			{
				// bottom east
				renderCube(0.475, -0.501, -0.501, 0.501, -0.475, 0.501, edgeBlock, edgeOverride);
			}

			if (!up)
			{
				// top east
				renderCube(0.475, 0.475, -0.501, 0.501, 0.501, 0.501, edgeBlock, edgeOverride);
			}
		}
		...
		if (!west)
		{
			...
			{
				// north west
				renderCube(-0.501, -0.501, -0.501, -0.475, 0.501, -0.475, edgeBlock, edgeOverride);
			}
			if (!south)
			{
				// south west
				renderCube(-0.501, -0.501, 0.475, -0.475, 0.501, 0.501, edgeBlock, edgeOverride);
			}
			if (!down)
			{
				// bottom west
				renderCube(-0.501, -0.501, -0.501, -0.475, -0.475, 0.501, edgeBlock, edgeOverride);
			}
			if (!up)
			{
				// top west
				renderCube(-0.501, 0.475, -0.501, -0.475, 0.501, 0.501, edgeBlock, edgeOverride);
			}
		}
		if (!north)
		{
			...
			{
				// top north
				renderCube(-0.501, 0.475, -0.501, 0.501, 0.501, -0.475, edgeBlock, edgeOverride);
			}
			if (!down)
			{
				// bottom north
				renderCube(-0.501, -0.501, -0.501, 0.501, -0.475, -0.475, edgeBlock, edgeOverride);
			}
		}
		...
		if (!south)
		{
			...
			{
				// top south
				renderCube(-0.501, 0.475, 0.475, 0.501, 0.501, 0.501, edgeBlock, edgeOverride);
			}
			if (!down)
			{
				// bottom south
