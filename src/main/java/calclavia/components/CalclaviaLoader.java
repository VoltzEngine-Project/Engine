...
public class CalclaviaLoader
{
	...
	public void preInit(FMLPreInitializationEvent evt)
	{
        ...
        ProxyHandler.applyModule(Waila.class, Calclavia.CONFIGURATION.get(Configuration.CATEGORY_GENERAL, "Enable_Waila_Support", true).getBoolean(true));
