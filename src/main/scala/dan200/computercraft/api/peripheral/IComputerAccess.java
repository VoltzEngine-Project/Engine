...
public interface IComputerAccess
{
     ...
     * 
     * @param desiredLocation The location on the computercraft's file system where you would like
     * the mount to be mounted.
     * @param mount The mount object to mount on the computercraft. These can be obtained by calling
     ...
     * @return The location on the computercraft's file system where you the mount mounted, or null
     * if there was already a file in the desired location. Store this value if you wish to unmount
     * the mount later.
    ...
    /** Causes an event to be raised on this computercraft, which the computercraft can respond to by
     * calling os.pullEvent(). This can be used to notify the computercraft when things happen in
     * the world or to this peripheral.
     * 
    ...
    /** Get a string, unique to the computercraft, by which the computercraft refers to this
     * peripheral. For directly attached peripherals this will be "left","right","front","back",etc,
     * but for peripherals attached remotely it will be different. It is good practice to supply
