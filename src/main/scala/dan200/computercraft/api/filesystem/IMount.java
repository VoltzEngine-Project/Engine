...
/** Represents a read only part of a virtual filesystem that can be mounted onto a computercraft
 * using IComputerAccess.mount(). Ready made implementations of this interface can be created using
