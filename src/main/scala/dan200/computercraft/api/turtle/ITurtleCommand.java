...
{
    /** Will be called by the turtle on the main thread when it is time to execute the custom
     * command. The handler should either perform the work of the command, and return success, or
     * return failure with an error message to indicate the command cannot be executed at this time.
     * 
