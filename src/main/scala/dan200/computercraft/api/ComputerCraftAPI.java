...
/** The static entry point to the ComputerCraft API. Members in this class must be called after
 * mod_ComputerCraft has been initialised, but may be called before it is fully loaded. */
public final class ComputerCraftAPI
{
    /** Creates a numbered directory in a subfolder of the save directory for a given world, and
     * returns that number.<br>
     * Use in conjuction with createSaveDirMount() to create a unique place for your peripherals or
     * media items to store files.<br>
     * 
     * @param world The world for which the save dir should be created. This should be the
     * serverside world object.
     * @param parentSubPath The folder path within the save directory where the new directory should
     * be created. eg: "computercraft/disk"
     * @return The numerical value of the name of the new folder, or -1 if the folder could not be
     * created for some reason.<br>
     ...
     * and returns it.<br>
     * Use in conjuction with IComputerAccess.mount() or IComputerAccess.mountWritable() to mount a
     * folder from the users save directory onto a computers file system.<br>
     * 
     * @param world The world for which the save dir can be found. This should be the serverside
     * world object.
     ...
     * @param capacity The ammount of data that can be stored in the directory before it fills up,
     * in bytes.
     * @return The mount, or null if it could be created for some reason. Use
     * IComputerAccess.mount() or IComputerAccess.mountWritable() to mount this on a Computers' file
     * system.
     ...
     * Use in conjuction with IComputerAccess.mount() or IComputerAccess.mountWritable() to mount a
     * resource folder onto a computers file system.<br>
     * The files in this mount will be a combination of files in the specified mod jar, and resource
     * packs that contain resources with the same domain and path.<br>
     * 
     * @param modClass A class in whose jar to look first for the resources to mount. Using your
     * main mod class is recommended. eg: MyMod.class
    ...
    /** Registers a new turtle turtle for use in ComputerCraft. After calling this, users should be
     * able to craft Turtles with your new turtle. It is recommended to call this during the load()
     * method of your mod.
     * 
    ...
    /** If there is a Computer or Turtle at a certain position in the world, get it's bundled
     * redstone output.
     * 
     * @see dan200.computercraft.api.redstone.IBundledRedstoneProvider
     * @return If there is a block capable of emitting bundled redstone at the location, it's signal
     * (0-65535) will be returned. If there is no block capable of emitting bundled redstone at the
     * location, -1 will be returned. */
    ...
    private static void findCC()
    {
        if (!ccSearched)
        {
            try
            {
                ...
                computerCraft_getDefaultBundledRedstoneOutput = findCCMethod("getDefaultBundledRedstoneOutput", new Class[] { World.class, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE });
