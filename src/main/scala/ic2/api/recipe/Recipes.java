...
public class Recipes
{
     ...
     * 
     * NBTTagCompound nbt = new NBTTagCompound(); nbt.setInteger("amplification", aValue);
     ...
     * 
     * 0.1: Diamond 0.5: Cake, Gold Helmet, Iron Ore, Gold Ore 1.0: Wooden tools, Soul Sand, Sign,
     * Leather, Feather, Bone 1.5: Apple, Bread 2.0: Netherrack, Rotten Flesh 3.0: Grass, Gravel
     * 4.0: Stick 5.0: Dirt, Wooden Hoe */
    public static IScrapboxManager scrapboxDrops;
    public static IListRecipeManager recyclerBlacklist;
    /** Do not add anything to this Whitelist. This is for Configuration only. You may need this if
     * you have an own Recycler in your Mod, just to check if something can be recycled. but don't
