...
public class CalclaviaLoader
{
        ...
        try
        {
            ...
            if (f == null)
            {
                ...
                else if (name.contains("dust"))
                {
                    ...
                    {
                        RecipeUtility.addRecipe(new ShapedOreRecipe(item, "!#!", '!', "ingotCopper", '#', "ingotTin"), Calclavia.CONFIGURATION, true);
    ...
    public void preInit(FMLPreInitializationEvent evt)
    {
        ...
        {
            Calclavia.LOGGER.fine("######Running mod as a dev IDE######");
            CalclaviaLoader.runningAsDev = true;
        }
    ...
    public void init(FMLInitializationEvent evt)
    {
        ...
        CalclaviaLoader.metadata.authorList = Arrays.asList(new String[] { "Calclavia", "DarkCow", "tgame14", "Maxwolf" });
