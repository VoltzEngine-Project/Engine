...
/** This interface is implemented by the computer case and robot tile entities to allow item
 * components to query the orientation of their host, i.e. to allow getting the facing of the tile
 * entity passed to their drivers'
...
public interface Rotatable
{
     ...
     * 
     * <pre>
     * class SomeDriver implements Item
     * {
     *     // ...
