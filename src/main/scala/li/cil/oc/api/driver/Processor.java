...
/** Use this interface to implement item drivers extending the number of components a server can
 * control.
 * <p/>
 * Note that the item must be installed in the actual server's inventory to work. If it is installed
 * in an external inventory the server will not recognize the memory. */
