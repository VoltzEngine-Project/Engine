 ...
 * <p/>
 * Note that the item must be installed in the actual computer's inventory to work. If it is
 * installed in an external inventory the computer will not recognize the memory. */
