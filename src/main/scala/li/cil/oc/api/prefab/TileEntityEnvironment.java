...
/** TileEntities can implement the {@link li.cil.oc.api.network.Environment} interface to allow them
 * to interact with the component network, by providing a {@link li.cil.oc.api.network.Node} and
...
public abstract class TileEntityEnvironment extends TileEntity implements Environment
{
     ...
     * {@link li.cil.oc.api.Network#newNode(Environment, li.cil.oc.api.network.Visibility)}.
     * <p/>
     * For example:
     * 
     * <pre>
