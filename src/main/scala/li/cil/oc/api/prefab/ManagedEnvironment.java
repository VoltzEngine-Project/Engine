...
/** Simple base implementation of the <tt>ManagedEnvironment</tt> interface, so unused methods don't
 * clutter the implementing class. */
public abstract class ManagedEnvironment implements li.cil.oc.api.network.ManagedEnvironment
{
    // Should be initialized using Network.newNode(). See TileEntityEnvironment.
    protected Node node;
