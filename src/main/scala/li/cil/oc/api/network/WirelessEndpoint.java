...
/** Interface for wireless endpoints that can be registered with the internal wireless network
 * registry.
 * <p/>
 * These can be added to the wireless network via the <tt>Network</tt> API, to allow them to receive
 * packets like wireless network cards and access points do (and handle or forward them as they see
 * fit).
 * <p/>
