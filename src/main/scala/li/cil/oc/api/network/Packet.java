...
/** These packets represent messages sent using a network card or wireless network card, and can be
 * relayed by the switch and access point blocks.
 * <p/>
...
public interface Packet
{
    ...
    /** The payload of the packet. This will usually only contain simple types, to allow persisting
     * the packet. */
    Object[] data();

    /** The remaining 'time to live' for this packet. When a packet with a TTL of zero is received it
     * will not be relayed by switches and access points. It will however still be received by a
     * network card. */
    int ttl();
