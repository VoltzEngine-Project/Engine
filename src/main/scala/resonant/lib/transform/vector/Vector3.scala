...
import resonant.lib.transform.{AbstractVector, ITransform}
...
class Vector3(var x: Double = 0, var y: Double= 0, var z: Double= 0) extends AbstractVector[Vector3] with Ordered[Vector3] with Cloneable with IVector3
{
  def this() = this(0, 0, 0)
