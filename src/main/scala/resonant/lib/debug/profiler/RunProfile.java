...
{
    public String name;
    public boolean enabled = ResonantEngine.runningAsDev;
    ...
    public StringBuilder getOutputSimple()
    {
        ...
        {
            string.append(TextUtility.padRight(section.getKey() +":", maxNameLength + 2) + TextUtility.formatNanoTime(section.getValue().getDelta()) +"\n");
        }
