package com.builtbroken.api.recipe;

import net.minecraft.block.Block;
import net.minecraft.item.Item;
import net.minecraft.item.ItemStack;
import net.minecraftforge.fluids.FluidStack;
import com.builtbroken.api.recipe.RecipeResource.FluidStackResource;
import com.builtbroken.api.recipe.RecipeResource.ItemStackResource;
import com.builtbroken.api.recipe.RecipeResource.OreDictResource;
