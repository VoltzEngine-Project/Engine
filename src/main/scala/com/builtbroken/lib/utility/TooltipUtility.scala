...
/**
 * The following code is Inspired by Sangar of Open Computers.
 * Mainly, the basic Resource code.
 *
 * @since 01/04/14
...
object TooltipUtility
{
   ...
   * equals check.
   *
   * @param stack1 stack to compare with stack2
   * @param stack2 stack to compare with stack1
   * @return whether they are fuzzyEquals to eachother
   */
