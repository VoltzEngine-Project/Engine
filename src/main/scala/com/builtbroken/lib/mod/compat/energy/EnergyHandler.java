package com.builtbroken.lib.mod.compat.energy;
...
public class EnergyHandler
{
	 ...
	 */
	public static final HashMap<Class, EnergySystem> energyHandlerCache = new HashMap<Class, EnergySystem>();
	public static final HashMap<Class, EnergySystem> energyStorageCache = new HashMap<Class, EnergySystem>();
    ...
    {
        EnergySystem module = getHandler(obj, direction);
    ...
    {
        EnergySystem module = getHandler(handler, direction);
        if(module != null)
        {
    ...
    {
        EnergySystem module = getHandler(itemStack, null);
        if(module != null)
        {
    ...
    {
        EnergySystem module = getHandler(is, null);
        if(module != null)
        {
