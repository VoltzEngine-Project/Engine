package com.builtbroken.lib.network.discriminator;
...
public class PacketAnnotationManager
{
	...
	public void sync(Object obj, int packetSetID)
	{
		...
		{
			BBL.instance.packetHandler.sendToAll(new PacketAnnotation(obj, packetSetID));
		}
		else
		{
			BBL.instance.packetHandler.sendToServer(new PacketAnnotation(obj, packetSetID));
		}
	}
