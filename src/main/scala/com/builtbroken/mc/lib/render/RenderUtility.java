...
public class RenderUtility
{
    ...
    {
        renderInventoryBlock(renderer, block, rotation == null ? 0 : rotation.ordinal(), colorMultiplier, null);
    }

    public static void renderInventoryBlock(RenderBlocks renderer, Block block, int meta)
    {
        renderInventoryBlock(renderer, block, meta, -1);
    }

    public static void renderInventoryBlock(RenderBlocks renderer, Block block, int meta, int colorMultiplier)
    {
        renderInventoryBlock(renderer, block, meta, colorMultiplier, null);
    }
