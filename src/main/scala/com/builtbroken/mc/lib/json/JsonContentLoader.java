...
public final class JsonContentLoader extends AbstractLoadable
{
    ...
    public final List<JsonProcessor> processors = new ArrayList();
    /** Entries loaded from file system */
    public final List<JsonEntry> jsonEntries = new ArrayList();
    ...
    public void init()
    {
        ...
        for (final JsonProcessor processor : processors)
        {
