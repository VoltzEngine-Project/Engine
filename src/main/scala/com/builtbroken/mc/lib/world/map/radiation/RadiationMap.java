 ...
 */
public class RadiationMap extends ChunkMap<RadiationChunk>
{
    public RadiationMap(int dimID)
    {
        super(dimID);
    }
    ...
    {
        RadiationChunk chunk = getChunkFromBlockCoords(x, z);
        if (chunk != null)
        {
    ...
    public short setRadiation(int x, int y, int z, short value)
    {
        ...
        {
            chunk = add(new RadiationChunk(x >> 4, z >> 4));
            chunk.setValue(x & 15, y, z & 15, value);
        }
        return 0;
    }
