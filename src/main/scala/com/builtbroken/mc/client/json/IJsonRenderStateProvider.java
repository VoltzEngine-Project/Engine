...
public interface IJsonRenderStateProvider
{
    ...
    String getRenderContentID(ItemCameraTransforms.TransformType renderType, Object objectBeingRendered);
     ...
     */
    @SideOnly(Side.CLIENT)
    default String getRenderStateKey(ItemCameraTransforms.TransformType renderType, String key, Object objectBeingRendered)
    {
        return null;
    }
