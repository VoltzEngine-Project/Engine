 ...
 */
public class ModelJsonProcessor extends JsonProcessor<ModelCustomData>
{
    @Override
    ...
    @Override
    public ModelCustomData process(JsonElement element)
    {
        ...
        return new ModelCustomData(this, key, domain, name);
    }
}
