 ...
 */
public class InventoryModule extends TileModule implements IExternalInventory, ISidedInventory, ISave
{
    /**
    ...
    public InventoryModule(ITileModuleProvider parent, int slots)
    {
        super(parent);
        this.slots = slots;
        if(parent instanceof IInventoryProvider)
        {
            this.host = (IInventoryProvider) parent;
        }
        else
        {
            throw new IllegalArgumentException("InventoryModule requires that the parent is an instance of IInentoryProvider");
        }
    }
