...
public interface IGridNetwork<N, C, A>
{
	...
	/**
	 * Gets the Set of AVAILABLE acceptors in this network. Make sure this doesn't include any stray acceptors which cannot accept
	 * resources.
	...
	/**
	 * Creates a new network that makes up the current network and the network defined in the parameters. Be sure to refresh the new
	 * network inside this method.
	 * @param network - network to merge
	 */
	public void merge(N network);
	
	/**
	 * Splits a network by the conductor referenced in the parameters. It will then create and refresh the new independent networks
	 * possibly created by this operation.
	 * @param connection
	 */
