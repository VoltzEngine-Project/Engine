...
public class ContainerBatteryBox extends Container
{
    ...
    public ContainerBatteryBox(InventoryPlayer par1InventoryPlayer, TileEntityBatteryBox batteryBox)
    {
        ...
        this.addSlotToContainer(new SlotUniversalElectricItem(batteryBox, 0, 33, 24)); //Top slot
        this.addSlotToContainer(new SlotUniversalElectricItem(batteryBox, 1, 33, 48)); //Bottom slot
        int var3;
