...
import basiccomponents.item.ItemCopperWire;
import basiccomponents.item.ItemOilBucket;
import basiccomponents.item.ItemOre;
...
public class BCLoader implements ICraftingHandler
{
	...
	public void load(FMLInitializationEvent evt)
    {
		...
		//Steel
		RecipeHelper.addRecipe(new ShapedOreRecipe(new ItemStack(BasicComponents.itemSteelDust), new Object [] {"!#!", '!', new ItemStack(Item.coal, 1, 1), '#', Item.ingotIron}), "Steel Dust", UniversalElectricity.CONFIGURATION, true);
