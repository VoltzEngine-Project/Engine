...
public class Localization
{
	...
	/**
	 * Adds localization from a given directory. The files must have the same name as the
	 * corresponding language file in minecraft and a ".properties" file extention e.g
	 * "en_US.properties"
	 * 
	 * @param path
	 *            The path to the localization files
	 * @param defaultLanguage
	 *            The default localization to be used when there is no localization for the selected
	 *            language or if a string is missing (e.g. "en_US")
	 */
