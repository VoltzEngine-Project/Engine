package universalelectricity.basiccomponents.multiblock;
...
public class TileEntityMulti extends TileEntity implements IPacketReceiver
{
    ...
    {
        return PacketManager.getPacket(UELoader.CHANNEL, this, this.mainBlockPosition.x, this.mainBlockPosition.y, this.mainBlockPosition.z);
    }
