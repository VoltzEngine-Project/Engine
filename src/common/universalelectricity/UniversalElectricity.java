...
public class UniversalElectricity
{
    ...
    //One IC2 EU is 0.012 Watt Hours. EU to Watt Hour
  	public static final float IC2_RATIO = (float)UEConfig.getConfigData(CONFIGURATION, "IC2 to UE Conversion Ratio", (int)(0.0055f*100000))/(float)100000;
  	
  	//One MJ is 13 Watt Hours. MJ to Watt Hour
  	public static final float BC3_RATIO = (float)UEConfig.getConfigData(CONFIGURATION, "BC3 to UE Conversion Ratio", (int)(0.055f*100000))/(float)100000;;
