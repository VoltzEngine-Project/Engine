...
public abstract class Crops
{
    ...
    /** Auto-assign an ID to a plant and register it. Usage of this method is not recommended! Other
     * plants could take your IDs and cause your plants to turn into other plants.
     * 
     * @param crop plant to register
     * @return The ID assigned to the plant */
    public abstract short registerCrop(CropCard crop);

    /** Attempt to register a plant to an ID. If the ID is taken, the crop will not be registered and
     * a console print will notify the user.
     * 
     * @param crop plant to register
