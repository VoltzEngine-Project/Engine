...
public interface ICropTile
{
    ...
    /** Get the crop's plant resistance stat. Higher values indicate more resistance against
     * trampling.
     * 
    ...
    /** Get the crop's plant custom data, stored alongside the crop. Can be modified in place.
     * 
    ...
    /** Get the crop's hydration storage. 0 indicates nothing, 1-10 indicate water hydration and
     * 11-100 for hydration cells.
     * 
    ...
    /** Get the crop's humidity. Ranges from 0 (dry) to 10 (humid). Updates every couple of seconds
     * or when an update is requested.
     * 
     * @see #updateState()
     * 
    ...
    /** Get the crop's nutrient level. Ranges from 0 (empty) to 10 (full). Updates every couple of
     * seconds or when an update is requested.
     * 
     * @see #updateState()
     * 
    ...
    /** Get the crop's air quality. Ranges from 0 (cluttered) to 10 (fresh). Updates every couple of
     * seconds or when an update is requested.
     * 
     * @see #updateState()
     * 
    ...
    /** Check if a block is under the farmland containing the crop. Searches up to 2 blocks below the
     * farmland or an air space, whichever appears first.
     * 
