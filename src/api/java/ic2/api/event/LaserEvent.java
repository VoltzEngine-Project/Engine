...
public class LaserEvent extends WorldEvent
{
     ...
     * 
     * The Laser will no longer exist after this Event is posted as it either Explodes or despawns
    ...
    /** Event when the Laser is hitting a Block x, y and z are the Coords of the Block.
     * 
     * Canceling this Event stops the Laser from attempting to break the Block, what is very useful
     * for Glass. Use lasershot.setDead() to remove the Shot entirely. */
     ...
     * 
     * Canceling this Event ignores the Entity Use lasershot.setDead() to remove the Shot entirely. */
