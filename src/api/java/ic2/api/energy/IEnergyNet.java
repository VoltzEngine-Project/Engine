...
public interface IEnergyNet
{
     ...
     * 
     * @note call this twice with x ticks delay to get the avg. emitted power p = (call2 - call1) /
     * x EU/tick
     * 
     ...
     * 
     * @note call this twice with x ticks delay to get the avg. sunken power p = (call2 - call1) / x
     * EU/tick
     * 
     * @param tileEntity energy emitter */
