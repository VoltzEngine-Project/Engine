...
/**
 * Components are permissions that can be addressed computers via drivers.
 * <p/>
 ...
 * according to the component's visibility. Therefore permissions won't receive
...
public interface Component extends Node {
     ...
     * is to be expected that there be multiple permissions with the same name, but
     * that those permissions all have the same underlying type (i.e. there can be
     * multiple "filesystem" permissions, but they should all behave the same way).
     */
    String name();
