 ...
 * <p/>
 * We use an extra class to deliver messages to permissions to make the cancel logic
...
public interface Message {
     ...
     * serving a message to a specific address and there are multiple permissions
