...
public interface Owner extends Context
{
    ...
    /**
     * This is called on the owner when the machine's {@link li.cil.oc.api.network.Environment#onConnect(li.cil.oc.api.network.Node)}
     ...
     * the machine's {@link li.cil.oc.api.network.Environment#onDisconnect(Node)} method is called.
     *
