...
/**
 * Vector2 Class is used for defining objects in a 2D space. Vector2 makes it easier to handle the coordinates of objects. Instead of
 * fumbling with x and y variables, all x and y variables are stored in one class. Vector3.x, Vector3.y.
 *
